...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex min-h-[calc(100vh-theme(spacing.4))] flex-1 flex-col  ",
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "data-[active=true]:bg-sidebar-accent data-[active=true]:text-sidebar-accent-foreground select-none",
        size === "sm" && "text-xs",
        size === "md" && "text-sm",
        "group-data-[collapsible=icon]:hidden",
        className
